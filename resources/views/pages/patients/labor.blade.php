<x-app-layout>
                ...
                <div class="card-inner card-inner-lg">
                    <div class="nk-block-head nk-block-head-lg pb-3">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h4 class="nk-block-title text-2xl fw-bold">Labor and Delivery</h4>
                                <div class="nk-block-des">
                                    <p>Patient information base on the Labor and Delivery.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="nk-block">
                        <div class="nk-data data-list">
                            <div class="data-head">
                                <h6 class="overline-title">Labor and Delivery Records</h6>
                            </div>
                            @include('pages.patients.labors.sub.laborlist')
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>This form is for Labor and Delivery.</p>
                    <hr class="mt-2 mb-2">
                    <form action="{{ route('labor.save') }}" id="labor_form" method="POST" autocomplete="off">
                        @csrf
                        @include('pages.patients.labors.sub.labor')
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        function edit_labor(id, dod, tod, pod, bod, bbw, lb, gender, hb, pph ) {

            const form = document.getElementById('labor_form');

            const dod_val = document.getElementById('inp_dod');
            const tod_val = document.getElementById('inp_tod');
            const pod_val = document.getElementById('inp_pod');
            const bod_val = document.getElementById('inp_bod');
            const bbw_val = document.getElementById('inp_bbw');
            const lb_val = document.getElementById('inp_lb');
            const gender_val = document.getElementById('inp_gender');
            const hb_val = document.getElementById('inp_hb');
            const pph_val = document.getElementById('inp_pph');
            ...
            form.action = "/prenatal/labor/update/" + id
        }
    </script>
